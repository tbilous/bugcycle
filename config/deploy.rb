...
set :application, 'dating'
set :repo_url, 'git@bitbucket.org:affairio_team/socapp.git'
...
append :linked_files, 'config/database.yml', 'config/secrets.yml', 'db/GeoIP.dat',
       'db/GeoLiteCity.dat', 'config/database_geo.yml'
